...
const Modal = (props) => {
  ...
  const [element, setElement] = useState(useRef(null))
  ...
  function handleSubmit(e){
    e.preventDefault();
    handleLogin(isEmailValid,props.setActiveProfileId,props.setLogin,props.toggleModal,setErrorMSG,setErrorMSGPassword, email, password,  ref.current, refPassword.current);
  }
  ...
  const resetValidationPassword = (element) => {
  ...
  return (
    ...
    <div className={props.isShowingModal ? "modal-container  mx-w-100 d-flex justify-content-center align-items-center " : "d-none" }>
      <section  className=' modal-con-desk mx-w-100 border opacity-100 bg-white rounded'>
        ...
        <div className="w-100 modal-login-con d-flex flex-row mb-3 justifiy-content-between align-items-center border-bottom border ">
          <div className='m-1 w-100 d-flex flex-row align-items'><img  className='modal-logo' src={Rocket} height={50} width={50} /><div className='d-flex justify-content-center align-items-center'><h3 className='modal-logo-text'>Login</h3></div></div>
            ...
            <div className='modal-cont-con d-flex w-100 flex-column justify-content-center align-items-center  '>
              ...
              <div className='w-100 d-flex align-items-center justify-content-center flex-row border-top mt-2'>
                ...
                <div 
                  ...
                  className='mt-3 mb-1 c-pointer'>
                    <span>Don't have an account?</span>
                </div>
                <div 
                  onClick={e => handleRegisterClick(e)}
                  className='mt-3 mb-1 handle-register-text c-pointer'>
                    <span> Register</span>
                </div>
              </div>
            </div>
